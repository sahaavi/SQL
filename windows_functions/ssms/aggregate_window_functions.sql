...
/*
Task - Return an animal's species, name, checkup time, heart rate, and a
Boolean column that is TRUE only for animals which all of their heart rate measurement were either equal
to, or larger than the average heart rate for their species.
*/
-- Routine Checkups
SELECT 	*
